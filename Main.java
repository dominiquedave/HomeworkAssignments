...
This program is written by: Dave Dominique */
...
public class Main extends Pairs {
	...
	public static void main(String[] args) throws FileNotFoundException { //ask if the way i read in is acceptable
	
		File file = new File("C:\\Users\\daved\\OneDrive\\Desktop\\input.txt"); //ask if the way i read in is acceptable
